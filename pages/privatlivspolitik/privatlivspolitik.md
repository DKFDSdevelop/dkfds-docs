...
<div class="row card-row">
    <div class="col-12 mt-805 d-none">
        <section class="card" id="cookieCardNoDecision">
    ...
    <div class="col-12 mt-805 d-none">
        <section class="card" id="cookieCardAccepted">
            <div class="card-content">
                <h2 class="card-heading">Det Fælles Designsystem bruger cookies</h2>
                <p>Vi indsamler statistik ved hjælp af tredjepartscookies til at forbedre brugeroplevelsen. Alle indsamlede data anonymiseres.</p>
                ...
                <div class="button-group card-actions">
                    <button type="button" class="button button-secondary" id="cookieCardRejectOnly">Nej til cookies</button>
                </div>
            </div>
        </section>
    </div>
    <div class="col-12 mt-805 d-none">
        <section class="card" id="cookieCardRejected">
            <div class="card-content">
                <h2 class="card-heading">Det Fælles Designsystem bruger cookies</h2>
                <p>Vi indsamler statistik ved hjælp af tredjepartscookies til at forbedre brugeroplevelsen. Alle indsamlede data anonymiseres.</p>
                ...
                <div class="button-group card-actions">
                    <button type="button" class="button button-secondary" id="cookieCardAcceptOnly">Acceptér cookies</button>
                </div>
            </div>
        </section>
    </div>
