  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>Ja, hvis inputfeltet er en del af en form</td>
        <td>Tekst</td>
      </tr>
      <tr>
        <td>inputid</td>
      ...
      <tr>
        <td>disabled</td>
        <td>Deaktiverer inputfeltet. Må ikke anvendes sammen med <code>error</code> og <code>required</code>.</td>
        <td>Nej</td>
        <td>Boolean attribut (dog vil værdien "false" ikke sætte attributten)</td>
      </tr>
      <tr>
        <td>readonly</td>
        <td>Sætter <code>readonly</code> på inputfeltet. Må ikke anvendes sammen med <code>error</code> og <code>required</code>.</td>
        <td>Nej</td>
        <td>Boolean attribut (dog vil værdien "false" ikke sætte attributten)</td>
      </tr>
      <tr>
        <td>required</td>
        <td>Anvend altid, hvis feltet er påkrævet. Må ikke anvendes sammen med <code>readonly</code> og <code>disabled</code>.</td>
        <td>Nej</td>
        <td>Boolean attribut (dog vil værdien "false" ikke sætte attributten)</td>
      </tr>
      <tr>
        <td>type</td>
        <td>Inputfeltets type. Hvis udeladt eller ugyldig, sættes værdien til <code>text</code>. Sørg for at vælge den type, der passer til inputfeltets forventede indhold.</td>
        <td>Nej</td>
        <td><code>text</code>, <code>email</code>, <code>number</code>, <code>password</code>, <code>tel</code> eller <code>url</code></td>
      </tr>
      <tr>
        <td>value</td>
        <td><p class="mt-0">Inputfeltets tekst. Hvis udeladt, er inputfeltet tomt.</p><p>Bemærk, at <code>value</code> opfører sig på samme måde som den normale value-attribut for inputfelter.</p></td>
        <td>Nej</td>
        <td>Tekst</td>
      </tr>
    </tbody>
...
<div class="table--responsive-scroll">
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
        <td>error</td>
        <td>Fejlmeddelelse, der skal vises over inputfeltet. Hvis sat, antages det at feltets indhold er ugyldigt. Må ikke anvendes sammen med <code>readonly</code> og <code>disabled</code>.</td>
        <td>Nej</td>
        <td>Tekst</td>
      </tr>
      <tr>
